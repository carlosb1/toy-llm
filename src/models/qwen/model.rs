...
mod tests {
    ...
    fn detect_gguf_quantization_q8_0() {
        ...
        tensors.insert(
            ...
            crate::models::qwen::gguf::GgufTensorInfo {
                name: "blk.0.attn_q.weight".to_string(),
                dims: vec![1024, 1024],
                dtype: crate::models::qwen::gguf::GgufDtype::Q8_0,
                offset: 0,
                num_elements: 1024 * 1024,
                data_size: 0,
            },
        );
        let gguf = crate::models::qwen::gguf::GgufFile {
    ...
    fn detect_gguf_quantization_q4_0() {
        ...
        tensors.insert(
            ...
            crate::models::qwen::gguf::GgufTensorInfo {
                name: "blk.0.attn_q.weight".to_string(),
                dims: vec![1024, 1024],
                dtype: crate::models::qwen::gguf::GgufDtype::Q4_0,
                offset: 0,
                num_elements: 1024 * 1024,
                data_size: 0,
            },
    ...
    fn detect_gguf_quantization_q4_k() {
        ...
        tensors.insert(
            ...
            crate::models::qwen::gguf::GgufTensorInfo {
                name: "blk.0.attn_q.weight".to_string(),
                dims: vec![1024, 1024],
                dtype: crate::models::qwen::gguf::GgufDtype::Q4_K,
                offset: 0,
                num_elements: 1024 * 1024,
                data_size: 0,
            },
    ...
    fn detect_gguf_quantization_q6_k() {
        ...
        tensors.insert(
            ...
            crate::models::qwen::gguf::GgufTensorInfo {
                name: "blk.0.attn_q.weight".to_string(),
                dims: vec![1024, 1024],
                dtype: crate::models::qwen::gguf::GgufDtype::Q6_K,
                offset: 0,
                num_elements: 1024 * 1024,
                data_size: 0,
            },
    ...
    fn detect_gguf_quantization_q5_k() {
        ...
        tensors.insert(
            ...
            crate::models::qwen::gguf::GgufTensorInfo {
                name: "blk.0.attn_q.weight".to_string(),
                dims: vec![1024, 1024],
                dtype: crate::models::qwen::gguf::GgufDtype::Q5_K,
                offset: 0,
                num_elements: 1024 * 1024,
                data_size: 0,
            },
    ...
    fn detect_gguf_quantization_q2_k() {
        ...
        tensors.insert(
            ...
            crate::models::qwen::gguf::GgufTensorInfo {
                name: "blk.0.attn_q.weight".to_string(),
                dims: vec![1024, 1024],
                dtype: crate::models::qwen::gguf::GgufDtype::Q2_K,
                offset: 0,
                num_elements: 1024 * 1024,
                data_size: 0,
            },
    ...
    fn detect_gguf_quantization_q3_k() {
        ...
        tensors.insert(
            ...
            crate::models::qwen::gguf::GgufTensorInfo {
                name: "blk.0.attn_q.weight".to_string(),
                dims: vec![1024, 1024],
                dtype: crate::models::qwen::gguf::GgufDtype::Q3_K,
                offset: 0,
                num_elements: 1024 * 1024,
                data_size: 0,
            },
    ...
    fn detect_gguf_quantization_f16_is_none() {
        ...
        tensors.insert(
            ...
            crate::models::qwen::gguf::GgufTensorInfo {
                name: "blk.0.attn_q.weight".to_string(),
                dims: vec![1024, 1024],
                dtype: crate::models::qwen::gguf::GgufDtype::F16,
                offset: 0,
                num_elements: 1024 * 1024,
                data_size: 0,
            },
