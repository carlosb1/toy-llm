...
use crate::models::qwen::mrope::{self, MRopeEmbedding};
use crate::models::qwen::sampling::Sampler;
use crate::models::qwen::transformer::{build_causal_mask, AttentionKvCache, Transformer};
use crate::models::qwen::vision::{VisionConfig, VisionEncoder};
                ...
                let weight_data = if use_f16 && dtype != safetensors::Dtype::F8_E4M3 {
                    ...
                    let f32_data: Vec<f32> = match dtype {
                        ...
                        safetensors::Dtype::F8_E4M3 => data
                            .iter()
                            .map(|&b| crate::models::qwen::model::fp8_e4m3_to_f32(b))
                            .collect(),
                        _ => continue,
                    };
